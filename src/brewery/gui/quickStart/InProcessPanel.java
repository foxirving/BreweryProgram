...
public class InProcessPanel extends JPanel {
	...
	public InProcessPanel(MainFrame mainFrame, AllPanels allPanels) {
		...
		GuiFactory.newLabel("InProcess Panel", container, 200, 200);

		GuiFactory.addButton(getParent(), "back", container, 400, 50,
				new ActionListener() {
					@Override
					public void actionPerformed(ActionEvent e) {

						panels.getInProcessPanel().setVisible(false);
